...
const ScrollArea = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ScrollAreaPrimitive.Root> & {
    ...
    /**
     * `maskHeight` is the height of the mask in pixels. pass `0` to disable the mask
     *
     * @default 30
     */
    maskHeight?: number;
      ...
      {isTouch ? (
        ...
        >
          <div
            ...
            // oxlint-disable-next-line jsx_a11y/no-noninteractive-tabindex: necessary for scrolling
            tabIndex={0}
          >
            {children}
          </div>
...
>(({ className, orientation = 'vertical', ...props }, ref) => {
  ...
  return (
    <ScrollAreaPrimitive.ScrollAreaScrollbar
      ...
      className={cn(
        'flex touch-none p-px transition-[colors] duration-150 select-none hover:bg-neutral-100 data-[state=hidden]:animate-out data-[state=hidden]:fade-out-0 data-[state=visible]:animate-in data-[state=visible]:fade-in-0 dark:dark:hover:bg-neutral-800/50 dark:hover:bg-neutral-800',
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className={cn(
          'relative flex-1 origin-center rounded-full bg-neutral-200 transition-[scale] dark:bg-neutral-800',
