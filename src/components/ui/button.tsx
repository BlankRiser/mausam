...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md font-medium transition-colors focus-visible:outline-hidden focus-visible:ring-1 focus-visible:ring-neutral-950 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none dark:focus-visible:ring-neutral-300",
  {
    variants: {
      variant: {
        default:
      ...
      size: {
        default: "text-sm h-9 min-w-9 px-2 py-2",
        sm: "text-sm h-8 min-w-8 rounded-md px-3 text-xs",
        lg: "text-sm h-10 min-w-10 rounded-md px-8",
        icon: "h-9 w-9",
      },
    },
    defaultVariants: {
