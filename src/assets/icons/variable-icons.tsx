    ...
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 512 512' {...props}>
      <defs>
        ...
        <symbol id='meteoconsThermometerRaindrop3' viewBox='0 0 118 278'>
          <use width='72' height='168' href='#meteoconsThermometerRaindrop1' transform='translate(23 87)'></use>
      ...
      <use width='118' height='278' href='#meteoconsThermometerRaindrop3' transform='translate(275 117)'></use>
    </svg>
  );
};
...
export const RelativeHumidity = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 512 512' {...props}>
      ...
      <use width='175' height='260.9' href='#meteoconsHumidity0' transform='translate(168.4 123.18)' />
      <path
        fill='currentColor'
...
export const Pressure = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 512 512' {...props}>
      <circle cx='256' cy='256' r='144' fill='none' stroke='currentColor' strokeMiterlimit='10' strokeWidth='12' />
      <path
        fill='none'
        stroke='currentColor'
        strokeLinecap='round'
...
export const ParticulateMatter25 = (props: SVGProps<SVGSVGElement>) => {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width='1em' height='1em' viewBox='0 0 512 512' {...props}>
      <defs>
        <linearGradient id='meteoconsPollenFill0' x1='145' x2='161' y1='3.1' y2='30.9' gradientUnits='userSpaceOnUse'>
      ...
      <use width='306' height='98' href='#meteoconsPollenFill7' transform='translate(103 207)'></use>
    </svg>
  );
};
