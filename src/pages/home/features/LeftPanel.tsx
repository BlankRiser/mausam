...
export const Header = () => {
    ...
    return (
        <div className="flex gap-2 items-center justify-center w-full">
            <h1 className="text-center text-lg font-semibold text-neutral-800 dark:text-neutral-200 py-4">Mausam</h1>
...
export const StationSummary = () => {
    ...
    return (
        <div className="flex flex-col gap-3 px-2">
            ...
            <InfoCard name="Network Short Name" value={currentStation.MNET_SHORTNAME ?? ""} />
        </div>
    );
};
