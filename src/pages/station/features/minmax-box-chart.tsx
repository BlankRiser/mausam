...
export const MinmaxBoxChart = ({ stationId, variable }: { stationId: string; variable: string }) => {
  ...
  return (
    <Card className='relative'>
      <CardHeader>
        <CardTitle>
          Min/Max values of {formattedVariable} {!!data && data?.UNITS?.[variable] ? `(${data.UNITS[variable]})` : ''}{' '}
          last 7 days
        </CardTitle>
      </CardHeader>
...
const getMinMaxData = (sensorVariables: SensorVariables, minMaxData: Record<string, MinMax>, sensor?: string) => {
